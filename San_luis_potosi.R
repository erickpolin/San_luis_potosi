...
ConcSan_luis_potosi<-Conc%>% 
  filter(entidad=="24")

remove(Conc)

#apparently this is a "flag", IDK what is this shit yet
ConcSan_luis_potosi$Nhog <- 1

#DECILES 

#Attaching the data frame
attach(ConcSan_luis_potosi) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcSan_luis_potosi<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcSan_luis_potosi) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcSan_luis_potosi$factor,to.data.frame=TRUE)
...
ConcSan_luis_potosi$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcSan_luis_potosi$MAXT<-ConcSan_luis_potosi$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcSan_luis_potosi<-ConcSan_luis_potosi[with(ConcSan_luis_potosi, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcSan_luis_potosi$ACUMULA<-cumsum(ConcSan_luis_potosi$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcSan_luis_potosi[dim(ConcSan_luis_potosi[ConcSan_luis_potosi$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcSan_luis_potosi<-rbind(ConcSan_luis_potosi[1:(dim(ConcSan_luis_potosi[ConcSan_luis_potosi$ACUMULA<tam_dec*i,])[1]+1),],
                    ConcSan_luis_potosi[(dim(ConcSan_luis_potosi[ConcSan_luis_potosi$ACUMULA<tam_dec*i,])[1]+1):dim(ConcSan_luis_potosi[1])[1],])
  
  b1<-tam_dec*i-ConcSan_luis_potosi[dim(ConcSan_luis_potosi[ConcSan_luis_potosi$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcSan_luis_potosi[(dim(ConcSan_luis_potosi[ConcSan_luis_potosi$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcSan_luis_potosi[(dim(ConcSan_luis_potosi[ConcSan_luis_potosi$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcSan_luis_potosi$ACUMULA2<-cumsum(ConcSan_luis_potosi$factor)

#aqu? estamos creando una variable que se llama decil que solo tiene ceros
ConcSan_luis_potosi$DECIL<-0
...
ConcSan_luis_potosi[(ConcSan_luis_potosi$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcSan_luis_potosi[((ConcSan_luis_potosi$ACUMULA2>tam_dec*i)&(ConcSan_luis_potosi$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcSan_luis_potosi[ConcSan_luis_potosi$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/San_luis_potosi")
write.dbf(ConcSan_luis_potosi,file="ConcSan_luis_potosi2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/San_luis_potosi")
write.dbf(ConcSan_luis_potosi,file="ConcSan_luis_potosi2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/San_luis_potosi")
Conc2010<-read.dbf("ConcSan_luis_potosi2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "San_luis_potosi por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "San_luis_potosi por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "San_luis_potosi por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "San_luis_potosi por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "San_luis_potosi por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "San_luis_potosi INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "San_luis_potosi INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "San_luis_potosi INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "San_luis_potosi INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "San_luis_potosi INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "San_luis_potosi NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "San_luis_potosi NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "San_luis_potosi NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "San_luis_potosi NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "San_luis_potosi NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/San_luis_potosi")
Conc2018<-read.dbf("ConcSan_luis_potosi2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "San_luis_potosi Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "San_luis_potosi Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "San_luis_potosi Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "San_luis_potosi Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "San_luis_potosi Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "San_luis_potosi INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "San_luis_potosi INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "San_luis_potosi INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "San_luis_potosi INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "San_luis_potosi INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "San_luis_potosi NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "San_luis_potosi NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "San_luis_potosi NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "San_luis_potosi NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "San_luis_potosi NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("San_luis_potosi por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("San_luis_potosi Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("San_luis_potosi NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("San_luis_potosi NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("San_luis_potosi INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("San_luis_potosi INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
